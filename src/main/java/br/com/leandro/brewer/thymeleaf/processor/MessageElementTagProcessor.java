package br.com.leandro.brewer.thymeleaf.processor;
...
public class MessageElementTagProcessor extends AbstractElementTagProcessor {
    ...
    protected void doProcess(ITemplateContext context, IProcessableElementTag tag, IElementTagStructureHandler structureHandler) {
        ...
        model.add(modelFactory.createStandaloneElementTag("div", "th:replace", "fragments/MensagensSucesso :: mensagensSucesso"));
        model.add(modelFactory.createStandaloneElementTag("div", "th:replace", "fragments/MensagensErroValidacao :: mensagensErro"));
